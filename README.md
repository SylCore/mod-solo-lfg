...
2. git clone https://github.com/SylCore/mod-solo-lfg.git
3. Re-run cmake and launch a clean build of SylCore. 
   a. If using SylCore Bash Dashboard setup: Do a ./acore.sh compiler configure followed by ./acore.sh compiler build.
...
2. Re-run cmake and launch a clean build of SylCore.
```
...
## Credits
(**Keeping these credits here to show respect to the authors of the module**)
*  [Traesh: Original Script](https://github.com/Traesh)
*  [Micrah/Milestorme: Module Creator](https://github.com/milestorme).
*  [Conan513](https://github.com/conan513).
*  [Artanisx](https://github.com/Artanisx) - Update for Docker installations. Updated LFG-Solo.patch to work with the latest SylCore version (17/09/2021). Updated standard installation instructions.
